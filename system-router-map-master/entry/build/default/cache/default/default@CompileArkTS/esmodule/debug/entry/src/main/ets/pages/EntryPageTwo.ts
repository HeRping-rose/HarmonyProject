...
interface PageTwo_Params {
    pageInfos?: NavPathStack;
}
import Logger from "@bundle:com.samples.systemrouter/entry/ets/common/utils/Logger";
export function PageTwoBuilder(name: string, param: Object, parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new PageTwo(parent ? parent : this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/EntryPageTwo.ets", line: 20, col: 3 });
...
export class PageTwo extends ViewPU {
    ...
    setInitiallyProvidedValue(params: PageTwo_Params) {
        if (params.pageInfos !== undefined) {
            this.pageInfos = params.pageInfos;
        }
    }
    updateStateVars(params: PageTwo_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                Button.pop();
                Column.pop();
            }, { moduleName: "entry", pagePath: "entry/src/main/ets/pages/EntryPageTwo" });
            NavDestination.title('entry-pageTwo');
...
(function () {
    if (typeof NavigationBuilderRegister === "function") {
        NavigationBuilderRegister("pageTwo", wrapBuilder(PageTwoBuilder));
    }
})();
